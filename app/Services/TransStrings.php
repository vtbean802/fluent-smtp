...
class TransStrings
{
    public static function getStrings()
    {
        return [
            ...
            'IAM Role (EC2/ECS)' => __('IAM Role (EC2/ECS)', 'fluent-smtp'),
            ...
            '__AWS_INSTANCE_ROLE_INSTRUCTION' => __('No access keys are required. FluentSMTP will automatically use the temporary credentials of the IAM role attached to your server (EC2 instance profile, Elastic Beanstalk environment or ECS/Fargate task role). Credentials are fetched from the AWS metadata service and are never stored in your database or files.', 'fluent-smtp'),
            '__AWS_INSTANCE_ROLE_PERMISSIONS' => __('The IAM role needs the following permissions: ses:SendRawEmail, ses:ListVerifiedEmailAddresses, ses:GetSendQuota and ses:GetSendStatistics.', 'fluent-smtp'),
